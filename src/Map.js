...
const Map = function () {
    ...
    const handleSubmit = (event) => {
        if (value.toUpperCase() !== 'DIBUJA LA RUTA')
            setFailed(true);
        else {
            setFailed(false);
            setCanOpen(true);
    ...
    return (<React.Fragment>
            ...
            <Box align={"center"} fill>
                ...
                <Box margin={"medium"} align={"center"}>
                    <Heading></Heading>
                    <Paragraph size={"xlarge"} fill>IWXeW HIWGMJVEQHS IO PIQWENI, OE GSQXVEWIRE IW: HMFYNE OE VYXE</Paragraph>
                    ...
                    {(canOpen &&
                        <Box>
                            <Heading>Este camino me resulta muy peculiar, tendrá algo que ver en como llegué hasta aquí…</Heading>
